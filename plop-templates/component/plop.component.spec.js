...
function main() {
    describe('{{properCase name}} component', function () {
        // Setting module for testing
        // Disable old forms
        beforeEach(function () {
            testing_1.TestBed.configureTestingModule({
                declarations: [TestComponent],
                imports: [{}, { properCase: name }] }, Module);
        });
    });
...
var TestComponent = (function () {
    ...
    TestComponent = __decorate([
        core_1.Component({
            selector: 'test-cmp',
            template: '<sd-{{kabobCase name}}></sd-{{kabobCase name}}>'
        }), 
        __metadata('design:paramtypes', [])
    ], TestComponent);
    return TestComponent;
}());
//# sourceMappingURL=plop.component.spec.js.map